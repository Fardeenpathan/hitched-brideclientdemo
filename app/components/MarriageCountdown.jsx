    ...
    return (
        <>
            <div className="bg-[url('/assets/countdown_bg.jpg')] bg-cover bg-no-repeat pb-12 md:pb-50 3xl:pb-40">
                <div className="lg:h-130 md:h-90 h-150">
                    ...
                    <p className="lg:text-[22px] text-[20px] text-[#FFF5B9] mt-4 text-center lg:px-100 md:px-25 px-10 font-Cormorant-upright">
                     ...
                     <p className="lg:text-[22px] text-[20px] text-[#FFF5B9] mt-4 text-center lg:px-100 md:px-25 px-10 font-Cormorant-upright">
                        With Best Compliments from, <br/>Vidya Jain,<br/> Pradeep & Sarita Jain,<br/> Ashutosh, Rishika & Ridham Jain, <br/>Sanjay, Suman, Dinesh Dolly, Shubham, Priyanka, Shivam, Ruchika & Viyana Jain <br/>
                    </p>
