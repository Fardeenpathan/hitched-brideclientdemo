    ...
    return (
        <>
            <div className="bg-[url('/assets/countdown_bg.jpg')] bg-cover bg-no-repeat pb-12 md:pb-50 3xl:pb-40">
                <div className="lg:h-140 md:h-90 h-150">
                    <h2 className="lg:text-[40px] text-4xl text-center text-[#FFF5B9] lg:pt-32 pt-12 font-Cormorant-upright">The countdown begins</h2> 
